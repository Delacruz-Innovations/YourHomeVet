  ...
  const benefits = [
    {
      ...
      side: 'left',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ec558b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 21.5c-1.5 0-2.5-1-3-2.5-.5-1.5-1.5-2.5-3-2.5C4.5 16.5 3 15 3 13c0-3.5 2.5-6 6-6 1.5 0 2.5.5 3 1.5.5-1 1.5-1.5 3-1.5 3.5 0 6 2.5 6 6 0 2-1.5 3.5-3 3.5-1.5 0-2.5 1-3 2.5-.5 1.5-1.5 2.5-3 2.5z"/>
    ...
    },
    {
      ...
      side: 'right',
      icon: <Heart size={28} className="text-green-500" />,
    ...
    },
    {
      ...
      side: 'left',
      icon: <Dog size={28} className="text-pink-500" />,
      margin: 'mt-8 md:mt-12'
    },
    {
      id: '04',
      ...
      side: 'right',
      icon: <PiggyBank size={28} className="text-blue-500" />,
    ...
    },
    {
      ...
      side: 'left',
      icon: <ShieldCheck size={28} className="text-pink-500" />,
      margin: 'mt-8'
    },
  ];
    ...
    <section className="bg-[#faf8f7] dark:bg-slate-900/60 py-16 px-4 sm:px-6 lg:px-8 font-sans overflow-hidden border-y border-slate-100 dark:border-slate-800">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16 relative">
        <div className="flex justify-center items-center gap-2 mb-3">
          ...
          <PawPrint className="text-pink-500 w-5 h-5" />
          <div className="h-0.5 w-4 bg-green-500 rounded-full"></div>
        </div>
        <h2 className="text-[#1a365d] dark:text-slate-100 text-3xl sm:text-4xl font-serif font-bold tracking-tight mb-1">
          5 Key Benefits of
        </h2>
        <h3 className="text-[#ec558b] text-3xl sm:text-4xl font-serif font-bold tracking-tight">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="hidden md:block absolute left-1/2 top-[52%] -translate-x-1/2 -translate-y-1/2 z-30">
          <div className="bg-white dark:bg-slate-900 rounded-full p-2 shadow-xl border-4 border-pink-200">
            <div className="bg-pink-50 dark:bg-slate-800 rounded-full p-5 relative">
              <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#ec558b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 21.5c-1.5 0-2.5-1-3-2.5-.5-1.5-1.5-2.5-3-2.5C4.5 16.5 3 15 3 13c0-3.5 2.5-6 6-6 1.5 0 2.5.5 3 1.5.5-1 1.5-1.5 3-1.5 3.5 0 6 2.5 6 6 0 2-1.5 3.5-3 3.5-1.5 0-2.5 1-3 2.5-.5 1.5-1.5 2.5-3 2.5z"/>
              </svg>
              <div className="absolute -bottom-1 -right-1 bg-green-500 rounded-full text-white shadow-md">
        ...
        {/* Base of Tree */}
        <div className="hidden md:block absolute bottom-0 left-1/2 -translate-x-1/2 w-28 h-5 bg-pink-400 rounded-full z-20 shadow-lg">
              ...
              <div key={item.id} className={`flex w-full relative ${isLeft ? 'md:justify-start' : 'md:justify-end'} ${item.margin}`}>
                <div className={`w-full md:w-[46%] bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-7 shadow-lg border border-slate-100 dark:border-slate-800 relative ${isLeft ? 'md:rounded-br-none' : 'md:rounded-bl-none'}`}>
                  ...
                  <div className="flex gap-4 sm:gap-5">
                    ...
                    {/* Text Content */}
                    <div>
                      <h3 className="text-[#1a365d] dark:text-slate-100 font-serif font-bold text-base sm:text-lg leading-tight mb-2 pr-2">
                        {item.title}
                      </h3>
