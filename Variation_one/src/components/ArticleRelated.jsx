...
export default function ArticleRelated() {
  return (
    <section className="w-full py-8 lg:py-12 lg:py-10 px-4 sm:px-6 lg:px-8 bg-[#f5f9fc] dark:bg-slate-900 transition-colors border-t border-slate-200 dark:border-slate-800">
